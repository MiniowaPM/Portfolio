...
export function ContactSlide({ topOffset, setToast }: ContactSlideProps) {
  ...
  return (
    <section
      className="slide-panel pointer-events-auto absolute left-[300vw] flex h-screen w-screen flex-col justify-center px-8 md:pr-[45vw] md:pl-20"
      style={{ top: topOffset }}
    >
      <div className="flex max-w-xl flex-col gap-8">
        ...
        {/* Główne przyciski akcji (Mail & CV) */}
        ...
        <div className="border-base-content/10 mt-4 flex items-center gap-6 border-t pt-6">
          {/* GitHub */}
          <a
